...
dismiss_ai_container.add_intent("dismiss", [" Nevermind", "Dismissed","Forget it", "Go away"])
...
date_container.add_intent("date", ["What time is it", "get the time", "get the date", "day of the week", "what day of the week is it", "what day is it"])
...
news_container.add_intent("play_news", ["what's on the news", "tell me the news", "play the bbc news", "restart news"])
...
alarm_container.add_intent("reminder", 
    ["Set alarms",
...
weather_container.add_intent("weather", 
    ["what is the weather",
...
random_container.add_intent("roll_dice", 
    ["Roll the dice",
        "roll dice", 
    ])
random_container.add_intent("flip_coin", 
    ["Flip a coin",
        "flip coin", 
])
...
play_music_container.add_intent("music", 
    ["Play {song} from {event}",
        "play {song}", 
        "list to {song}"
])
